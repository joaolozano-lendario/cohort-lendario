...
import styles from './ImersaoSupport.module.css';

export default function ImersaoSupport() {
    const handleWhatsAppClick = () => {
        // Distribuição 50/50 entre os dois números
        const numbers = [
        ...
        <section className={styles.supportSection}>
            <div className={styles.container}>
                <div className={styles.card}>
                    ...
                    <p className={styles.description}>Fala com o nosso time de suporte.</p>
